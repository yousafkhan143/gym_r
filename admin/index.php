...
<div class="col-md-6 col-lg-6">
          <?php
                  ...
                  foreach($dbh->query('SELECT SUM(payment) 
FROM tblpayment') as $row)
                  {
                   
                  ?>
                  <a href="#"> 
          <div class="widget-small primary coloured-icon"><i class="icon fa fa-credit-card fa-3x"></i></i>
            <div class="info">
              <h4>Total Earned money</h4>
              <p><b><?php echo $row['SUM(payment)']?></b></p>
            </div>
          </div>
        </a>
            <?php  } ?>
