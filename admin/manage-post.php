              ...
              <table class="table table-hover table-bordered" id="sampleTable">
                ...
                <tbody>
                  ...
                  <td>
                   ...
                   <a href="edit-post.php?pid=<?php echo htmlentities($result->packageid);?>" class="btn btn-success">Edit</a>
                  
                   <a href="del-post.php?pid=<?php echo htmlentities($result->packageid);?>"class="btn btn-danger">Delete</a>
                  </td>
