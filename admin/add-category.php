...
$sqlSelect = "SELECT * FROM tbladdpackage WHERE category=:del";
              ...
              <table class="table table-hover table-bordered" id="sampleTable">
                ...
                <tbody>
                  <tr>
                    ...
                    <td>
                      <a href="edit-category.php?cid=<?php echo htmlentities($result->id);?>"><button class="btn btn-primary" type="button">Edit</button></a> 
                      <a onclick=" confirm('Are you sure you want to Delete this category?')" href="add-category.php?del=<?=$result->id;?>"><button class="btn btn-danger" type="button">Delete</button></a></td>
                  </tr>
                    <?php  $cnt=$cnt+1; } } ?>
