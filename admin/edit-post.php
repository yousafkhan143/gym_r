            ...
            <div class="tile-body">
              <form class="row" method="post">
                <div class="form-group col-md-6">
                 ...
                 <div class="form-group col-md-6">
                  <label class="control-label">Package Type</label>
                   <select name="package" id="package" class="form-control"onChange="getdistrict(this.value);" required>
                ...
                <div class="form-group col-md-6">
                  ...
                  <input class="form-control" name="titlename" id="titlename" type="text" placeholder="Enter your Title Name" value="<?php echo $result->titlename;?>"required>
                </div>
                 ...
                 <div class="form-group col-md-6">
                  ...
                  <input class="form-control" type="text" name="packageduratiobn" name="packageduratiobn" placeholder="Enter Package Duratiobn" value="<?php echo $result->PackageDuratiobn;?>"required>
                </div>

                 <div class="form-group col-md-6">
                  <label class="control-label">Price</label>
                  <input class="form-control" type="text" name="Price" id="Price" placeholder="Enter your Price" value="<?php echo $result->Price;?>"required>
                </div>
