...
if (strlen($_SESSION['adminid'] == 0)) {
    ...
    if (isset($_POST['Submit'])) {
        ...
        $sql = "INSERT INTO tbladdpackage (category,titlename,PackageType,PackageDuratiobn,Price,Description)
Values(:category,:titlename,:package,:packageduratiobn,:Price,:description)";
