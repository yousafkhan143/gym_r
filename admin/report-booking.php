...
?>
       <div class="row">
        ...
        <th>PackageName</th>
                  ...
                  <?php
                  $sql="SELECT t1.id as bookingid,t3.fname as Name,tblpayment.payment, t3.email as email,t1.booking_date as bookingdate,t2.titlename as title,t2.PackageDuratiobn as PackageDuratiobn,
                  ...
                  JOIN tblpayment WHERE t1.id = tblpayment.bookingID AND
                 
 date(booking_date) between :fdate and :tdate";
                ...
                <!-- style="background-color: #32363287;" -->
                  <tr >
                   ...
                   $sqli = "SELECT SUM(payment) AS total_sum FROM  tblpayment WHERE DATE(payment_date) between :fdate and :tdate";
                  //  echo " data ";
                  ...
                  //  $results = $query -> fetchAll(PDO::FETCH_OBJ);  
                   ...
                   ?>
                    <td colspan="6" class="text-center" ><h3> Total Earn</h3></td>
                    <td colspan="1" class="text-center"><h3><?=$total_sum;?></h3></td>
<td>                      <button onclick="window.print()"  class="btn btn-outline-info" >Print Report</button>
</td>
                  </tr>
