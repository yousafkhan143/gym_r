            ...
            <div class="tile-body">
              <table class="table table-hover table-bordered" id="sampleTable">
               ...
               <?php
                  ...
                  t1.PackageName,
                  t2.category_name
                  FROM tblpackage AS t1 join tblcategory AS t2 ON
                  t1.cate_id = t2.id";
                  $query= $dbh->prepare($sql);
                  $query-> execute();
                ...
                <tbody>
                  <tr>
                    ...
                    <td>
                      <a href="edit-pack.php?cid=<?php echo htmlentities($result->id);?>"><button class="btn btn-primary" type="button">Edit</button></a> 
                     <a onclick=" confirm('Are you sure you want to Delete this category?')" href="add-package.php?del=<?php echo htmlentities($result->id);?>"><button class="btn btn-danger" type="button">Delete</button></a></td>
                  </tr>
                    <?php  $cnt=$cnt+1; } } ?>
