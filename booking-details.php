	...
	<section class="contact-page-section spad overflow-hidden">
		<div class="container">
			...
			<div class="row">
				...
				<div class="col-lg-12">
					   <table class="table table-bordered table-responsive schedule-table aos-init tb-border  ">
                <thead  class="thead tb-border">
...
if($ptype==''):
 ...
 where bookingID=:bookindid";
                  ...
                  if($query -> rowCount() > 0)
                  { ?>
                       <table class="table table-bordered table-responsive aos-init tb-border">
                        <thead class="tb-border">
                        <tr >
                          <th colspan="3" style="text-align:center;font-size:20px;color:#fff;">Payment History</th>
                        </tr>
                        <tr class="th-color">
                          <th >Payment Type</th>
                          <th>Amount Paid</th>
